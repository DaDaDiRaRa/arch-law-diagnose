...
- [x] **D. 골든 케이스 회귀셋** — ✅ 골격+실제 **10건** 완료 (2026-06-29). `tests/golden/*.json`(익명화·숫자만) + `test_golden_cases.py`(조례 stub + `_diagnose` skip_ai 결정론, actual_pct ±0.01%p 허용으로 원문 절사 흡수). M드라이브 실 인허가 건축개요서 10건 추출(식별정보 전부 제외, 수치·용도지역만). **용도지역 6종 커버**: 일반상업(오피스텔 68.04/699.80·업무재개발 58.21/799.51·여의도주상복합 38.35/489.99), 준주거(주거복합 59.84/377.14), 제2종일반주거(재개발 20.05/229.70·목동재건축 25.05/299.87), 제3종일반주거(방배재건축 24.08/299.99·수지초 교육 29.99/117.83), 중심상업(대구주상복합 56.48/800.50), 지구단위(광교 59.95/269.57). 재건축·아파트·공동주택·업무·교육 등 유형 다양. 다수가 법정/상한 면도날 통과. 스키마·익명화 규칙은 `golden/README.md`. 테스트 +10(전체 282). ※ 제거된 Step 8(케이스 매칭)과 다른 *정답 측정*. ⏳ 남은 용도지역(1종일반주거·전용주거·근린/유통상업·준공업·녹지)·시설(근생·숙박·의료·물류)은 `golden/`에 JSON만 추가하면 자동 수집 — 후보 카탈로그 scratchpad `m_cat2.tsv`·`m_gaeyo.tsv`·`m_hits.tsv`.
