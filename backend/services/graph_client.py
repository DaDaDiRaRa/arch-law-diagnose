...
# graph uvicorn 기본 8001. 미배포여도 호출 실패 시 degrade 라 무해.
_GRAPH_API_URL = os.getenv("GRAPH_API_URL", "http://localhost:8001").rstrip("/")
_TIMEOUT = float(os.getenv("GRAPH_API_TIMEOUT", "4"))
